...
export async function GET(request, { params }) {
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to fetch evaluation', details: error.message },
      { status: 500 }
    );
  } finally {
    if (connection) {
...
export async function PUT(request, { params }) {
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to update evaluation', details: error.message },
      { status: 500 }
    );
  } finally {
    if (connection) {
...
export async function DELETE(request, { params }) {
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to delete evaluation', details: error.message },
      { status: 500 }
    );
  } finally {
    if (connection) {
