...
export default function GeneralOverviewPage() {
  ...
  const communities = [
    { id: 1, name: "หมู่ 1 บ้านสนามจันทร์", description: "บ้านสนามจันทร์" },
    { id: 2, name: "หมู่ 2 บ้านคลองหลอดยอ", description: "บ้านคลองหลอดยอ" },
    { id: 3, name: "หมู่ 3 บ้านคลองชวดแค", description: "บ้านคลองชวดแค" },
    { id: 4, name: "หมู่ 4 บ้านตลาดทด", description: "บ้านตลาดทด" },
  ];
    ...
    >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              {communities.map((community) => (
                <div
                  key={community.id}
                  className="bg-white bg-opacity-95 rounded-xl shadow-lg p-6 backdrop-blur-sm hover:shadow-xl transition-shadow"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-3">
                    มีลำคลอง 8 แห่ง ไหลผ่านพื้นที่ลงสู่แม่น้ำบางปะกง
                  </p>
            ...
            <div className="bg-white bg-opacity-95 rounded-2xl shadow-lg p-8 backdrop-blur-sm">
              ...
              <div className="text-center mb-8">
                <p className="text-gray-700 leading-relaxed">
                  เทศบาลตำบลบ้านโพธิ์อยู่ในเขตมรสุม
                  ได้รับอิทธิพลจากลมทะเลประจำถิ่นภาคตะวันออกของประเทศ
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      อยู่ในเขตมรสุมที่ได้รับอิทธิพลจากลมทะเล
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      ตั้งอยู่ในภาคตะวันออกของประเทศไทย
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white bg-opacity-95 rounded-2xl shadow-lg p-8 backdrop-blur-sm">
              ...
              <p className="text-gray-700 leading-relaxed text-center mb-8">
                ประชากรส่วนใหญ่ของเทศบาลตำบลบ้านโพธิ์
                ประกอบอาชีพค้าขายและเกษตรกรรม เช่น ทำนา ทำสวน
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {occupations.map((occupation, index) => (
                <div
                  key={index}
                  className="bg-white bg-opacity-95 rounded-xl shadow-lg p-8 backdrop-blur-sm"
                >
            ...
            <div className="bg-white bg-opacity-95 rounded-2xl shadow-lg p-8 backdrop-blur-sm">
              ...
              <div className="bg-red-50 rounded-lg p-6">
                ...
                <div className="text-gray-700 leading-relaxed text-justify">
                  <p>
                    แต่เนื่องจากน้ำในแม่น้ำบางปะกง มีความเค็มนานถึง ปีละ 6 - 8
                    เดือน ทำให้ดินมีสภาพเค็มและเป็นกรด ขาดความสมบูรณ์ในการทำนา
                    ทำสวนและปลูกพืชไร่อย่างอื่น รวมทั้งน้ำในดินมีความเค็มสูง
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="w-full max-w-[1268px] mt-8">
        <div className="bg-white bg-opacity-90 rounded-2xl shadow-md p-6 backdrop-blur-sm text-center">
          ...
          <p className="text-gray-600 text-sm">
            ข้อมูลพื้นฐานเกี่ยวกับการปกครอง ภูมิศาสตร์ ภูมิอากาศ
