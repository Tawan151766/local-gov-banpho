...
export default function ChildDevelopmentDetailPage({ params }) {
        ...
        <div className="bg-white bg-opacity-95 rounded-2xl shadow-lg backdrop-blur-sm overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white opacity-90">ประเภท: {data?.type_name || "ศูนย์พัฒนาเด็กเล็ก"}</p>
                </div>
              </div>
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="mb-6 p-4 bg-blue-50 rounded-lg">
              ...
              <div className="inline-block px-3 py-1 rounded-full text-white text-sm font-medium bg-[#01bdcc]">{data?.type_name || "ศูนย์พัฒนาเด็กเล็ก"}</div>
            </div>
            {/* Tab Navigation */}
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-3">
                ...
                <Link href="/child-development"><button className="px-4 py-2 bg-[#01bdcc] text-white rounded-lg hover:bg-[#01a5b3] transition-colors">กลับหน้ารายการ</button></Link>
              </div>
            </div>
          </div>
        </div>
