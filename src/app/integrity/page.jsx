        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="prose max-w-none">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                เทศบาลตำบลบ้านโพธิ์ มีเจตจำนงที่จะบริหารงานด้วยความสุจริต
                โปร่งใส และเป็นธรรม เพื่อประโยชน์สุขของประชาชนในพื้นที่
                โดยยึดหลักการบริหารจัดการที่ดี (Good Governance)
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li> ใช้งบประมาณอย่างคุ้มค่า เกิดประโยชน์สูงสุดแก่ประชาชน</li>
              ...
              <p>
                เทศบาลตำบลบ้านโพธิ์ มุ่งมั่นที่จะให้บริการประชาชนด้วยความรวดเร็ว
                ถูกต้อง และเป็นธรรม โดยปรับปรุงกระบวนการทำงานให้มีประสิทธิภาพ
              ...
              <p>
                การพัฒนาท้องถิ่นจะดำเนินการตามแผนพัฒนาท้องถิ่น
                โดยให้ประชาชนมีส่วนร่วม ในการกำหนดทิศทาง การดำเนินงาน
                และการติดตามประเมินผล เพื่อให้การพัฒนา
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">
                    คู่มือจริยธรรมสำหรับเจ้าหน้าที่
                  </h4>
                  <p className="text-sm text-gray-500">
                    เทศบาลตำบลบ้านโพธิ์ (PDF)
                  </p>
                </div>
              </div>
              <button className="px-4 py-2 bg-[#0383AA] text-white rounded-lg hover:bg-[#0383AA]/90 transition-colors">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-600 text-sm">โทร: 0-3858-7308</p>
              <p className="text-gray-600 text-sm">
                อีเมล: office@banphocity.go.th{" "}
              </p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">
