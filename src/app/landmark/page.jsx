...
// ข้อมูลสถานที่สำคัญ (อัปเดตตามที่ขอ)
const landmarks = [
  {
    id: "government",
    ...
    places: [
      ...
      {
        name: "สาธารณสุขอำเภอบ้านโพธิ์",
        address: "หมู่ 1 ตำบลบ้านโพธิ์ อำเภอบ้านโพธิ์ จังหวัดฉะเชิงเทรา 24140",
        phone: "038-587-778",
        type: "สำนักงานสาธารณสุข",
        mapLink: "https://maps.app.goo.gl/BanPhoHealth"
      }
    ]
  },
  {
    ...
    places: [
      ...
      {
        name: "โรงเรียนวิทยาราษฎร์รังสรรค์",
        address: "หมู่ 1 ตำบลบ้านโพธิ์ อำเภอบ้านโพธิ์ จังหวัดฉะเชิงเทรา 24140",
        phone: "038-587-201",
        type: "โรงเรียนประถมและมัธยมศึกษา",
        mapLink: "https://maps.app.goo.gl/VitthayaRassadornRangsarn"
      },
      {
        name: "โรงเรียนวัดสนามจันทร์",
        address: "หมู่ 1 ตำบลบ้านโพธิ์ อำเภอบ้านโพธิ์ จังหวัดฉะเชิงเทรา 24140",
        phone: "038-587-302",
        type: "โรงเรียนประถมศึกษา",
        mapLink: "https://maps.app.goo.gl/WatSanamChanSchool"
      }
    ]
  },
  {
    ...
    places: [
      {
        ...
        phone: "038-587-100",
        type: "วัดหลวง",
        mapLink: "https://maps.app.goo.gl/WatSanamChan"
      },
      {
        name: "วัดบ้านโพธิ์",
        address: "หมู่ 1 ตำบลบ้านโพธิ์ อำเภอบ้านโพธิ์ จังหวัดฉะเชิงเทรา 24140",
  ...
  },
  {
    ...
    places: [
      {
        name: "ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร (ธกส.) สาขาบ้านโพธิ์",
        address: "หมู่ 1 ตำบลบ้านโพธิ์ อำเภอบ้านโพธิ์ จังหวัดฉะเชิงเทรา 24140",
        phone: "038-587-011",
      ...
      {
        name: "ธนาคารกรุงเทพ สาขาบ้านโพธิ์",
        address: "หมู่ 1 ตำบลบ้านโพธิ์ อำเภอบ้านโพธิ์ จังหวัดฉะเชิงเทรา 24140",
        phone: "038-587-012",
        type: "ธนาคารพาณิชย์",
        mapLink: "https://maps.app.goo.gl/BBLBanPho"
      }
    ]
  },
  {
