    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4 text-center">ข้อมูลเบี้ยยังชีพผู้สูงอายุ</h1>
          <p className="text-lg text-gray-600 mb-6 text-center">รายละเอียดและขั้นตอนการขอรับเบี้ยยังชีพสำหรับผู้สูงอายุในเทศบาลตำบลบ้านโพธิ์</p>
